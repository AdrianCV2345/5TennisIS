...
describe("TennisScorer", () => {
  ...
  it ("El jugador 1 marca 4 puntos y el jugador 2 en cero", () => {
   const scorer = new TennisScorer();
   scorer.player1Scores();
   scorer.player1Scores();
   scorer.player1Scores();
  ...
  it("El jugador 2 marca un punto y el jugador 1 en cero", () => {
    const scorer = new TennisScorer();
    scorer.player2Scores();
    expect(scorer.showScore()).toEqual("Love - 15");
  });

  it("El jugador 2 marca 2 puntos y el jugador 1 en cero", () => {
    const scorer = new TennisScorer();
    scorer.player2Scores();
    scorer.player2Scores();
    expect(scorer.showScore()).toEqual("Love - 30");
  });
  it("El jugador 2 marca 3 puntos y el jugador 1 en cero", () => {
    const scorer = new TennisScorer();
    scorer.player2Scores();
    scorer.player2Scores();
    scorer.player2Scores();
  ...
  it ("El jugador 2 marca 4 puntos y el jugador 1 en cero", () => {
   const scorer = new TennisScorer();
   scorer.player2Scores();
   scorer.player2Scores();
   scorer.player2Scores();
  ...
  it("El jugador 2 tiene ventaja", () => {
    ...
    scorer.player2Scores();
    scorer.player2Scores();
    expect(scorer.showScore()).toEqual("Player 2 advantage"); 
  });
});
